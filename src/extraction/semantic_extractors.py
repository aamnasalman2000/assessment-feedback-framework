...
class SemanticExtractor:
    ...
    def _extract_single_unit(
        ...
        *,
        ...
        # Domain annotations are deterministic and owned by Python.
        annotation_data[
            "domain_annotations"
        ...
        # Per-unit extraction does not generate meaningful
        # self-referential relationships.
        annotation.relationships = [
            relationship
            for relationship
            in annotation.relationships
            if (
    ...
    def _build_unit_output_schema(
        *,
        ...
        if isinstance(properties, dict):
            # Domain annotations are generated by Python,
            # not by the model.
            properties.pop(
                "domain_annotations",
                None,
            ...
            # Relationships are deliberately disabled
            # during per-unit semantic extraction.
        ...
        current_unit_id = unit.get(
            "unit_id"
        )

        # Per-unit extraction only needs the current
        # unit as a valid evidence/reference target.
        valid_reference_unit_ids = (
            [current_unit_id]
            if isinstance(
                current_unit_id,
                str,
